...
import com.daromi.koa.core.datatypes.Types
...
value class Column(
    ...
    override fun toField(context: LogicalOperator): Field {
        val field = context.schema.field(this.name) ?: throw NoSuchElementException("unknown column '${this.name}'")
        return field
    }
...
value class BooleanLiteral(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Boolean)
...
value class Int8Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Int8)
...
value class Int16Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Int16)
...
value class Int32Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Int32)
...
value class Int64Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Int64)
...
value class UInt8Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.UInt8)
...
value class UInt16Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.UInt16)
...
value class UInt32Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.UInt32)
...
value class UInt64Literal(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.UInt64)
...
value class FloatLiteral(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Float)
...
value class DoubleLiteral(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value.toString(), Types.Double)
...
value class StringLiteral(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.value, Types.String)
...
abstract class BinaryBooleanExpression(
    ...
    override fun toField(context: LogicalOperator): Field = Field(this.name, Types.Boolean)
...
class Count(
    ...
    override fun toField(context: LogicalOperator): Field = Field("COUNT", Types.Int32)
